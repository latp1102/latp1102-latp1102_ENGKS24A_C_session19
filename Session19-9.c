...
void inSV(struct SinhVien menu[], int n);
void themSV(struct SinhVien menu[], int *n);
void suaSV(struct SinhVien menu[], int n);
void xoaSV(struct SinhVien menu[], int *n);
void timKiemSV(struct SinhVien menu[], int n);
void sapXepSV(struct SinhVien menu[], int n);
